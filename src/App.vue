          ...
          <div class="card_content">
            ...
            <div class="card_text">
              <p>
                ...
                features a mixture of leafy greens and seasonal vegetables,
          ...
          <div class="card_content">
            ...
            <div class="card_text">
              <p>
                ...
                level! More than 650 hours of fermenting, brining, aging, and
                curing goes into each and every one of our legendary Reuben
                sandwiches.
              </p>
              <p>
                This unforgettable sandwich has all of the classic Reuben
                elements:
                <em>No substitions please!</em>
              </p>
              <p class="upcharge bg-secondary">
                <button class="button bg-primary">
                  <svg
      ...
      <li class="cards_item">
        <div class="card bg-primary" tabindex="0">
          ...
          <div class="card_content">
            ...
            <div class="card_text">
              <span class="note bg-secondary">Offerta Speciale!</span>
              <p>
