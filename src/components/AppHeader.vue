      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto" id="navbar-sticky">
        <ul
          ...
          <li>
            ...
            <router-link
              class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-secondary md:hover:bg-transparent md:hover:text-secondary hover:text-white md:p-0"
              :to="{ name: 'about' }">Chi Siamo</router-link>
          </li>
          <li>
            <a href="#"
              class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-secondary md:hover:bg-transparent md:hover:text-secondary hover:text-white md:p-0">Contatti</a>
          </li>
          <li>
            <router-link
