...
<template>
  <nav
    class="bg-primary fixed w-full z-20 top-0 left-0 border-b border-gray-200"
  >
    <div
      ...
      >
        ...
        >
          ...
          <li>
            <button
              type="button"
              class="text-white bg-secondary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0"
            >
              Login
            </button>
          </li>
